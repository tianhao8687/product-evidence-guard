...
package(D,3,"接入点嵌套 JSON 继承","json_nested_specs",{"spec.json":json.dumps({"SKU":"ACCESSPOINT","specs":{"输入电压":"12V","协议":"802.11ax","工作频率":"2.4GHz"}},ensure_ascii=False)},
        [identity("ACCESSPOINT"),f("ACCESSPOINT","voltage",12,"V","input"),f("ACCESSPOINT","protocol","802.11ax"),f("ACCESSPOINT","frequency","2.4ghz",None,"operating","pending_confirmation")])
